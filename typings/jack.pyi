...
class Client:
    ...
    def transport_query_struct(self) -> Tuple[TransportState, JackPositionT]: ...
    def transport_reposition_struct(self, position: JackPositionT) -> None: ...  # TODO
    ...
    def set_port_registration_callback(self, callback: Callable[[Port, bool], None], only_available: bool = ...) -> None: ...
    def set_port_connect_callback(self, callback: Callable[[Port, Port, bool], None], only_available: bool = ...) -> None: ...
    def set_port_rename_callback(self, callback: Callable[[Port, str, str], None], only_available: bool = ...) -> None: ...
    ...
    def set_sync_callback(self, callback: Optional[Callable[[int, JackPositionT], None]]) -> None: ...
    def release_timebase(self) -> None: ...
    def set_timebase_callback(
        self, callback: Callable[[int, int, JackPositionT, bool], None], conditional: bool = ...
    ) -> bool: ...
...
class OwnPort(Port):
    ...
    def get_buffer(self) -> CBufferType: ...
...
class OwnMidiPort(MidiPort, OwnPort):
    ...
    def incoming_midi_events(
        self,
    ) -> Generator[Tuple[int, CBufferType], None, None]: ...
    def clear_buffer(self) -> None: ...
    def write_midi_event(self, time: int, event: Union[bytes, Sequence[int], CBufferType]) -> None: ...
    def reserve_midi_event(self, time: int, size: int) -> CBufferType: ...
...
class RingBuffer:
    ...
    def write(self, data: Union[bytes, Iterable[int], CBufferType]) -> int: ...
    @property
    def write_buffers(self) -> Tuple[CBufferType, CBufferType]: ...
    def write_advance(self, size: int) -> None: ...
    @property
    def read_space(self) -> int: ...
    def read(self, size: int) -> CBufferType: ...
    def peek(self, size: int) -> CBufferType: ...
    @property
    def read_buffers(self) -> Tuple[CBufferType, CBufferType]: ...
...
def position2dict(pos: JackPositionT) -> Dict[str, Any]: ...
